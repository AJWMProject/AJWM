...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ajwm-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ajwm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ajwm transaction") + "\n" +
              "  ajwm-tx [options] -create [commands]   " + _("Create hex-encoded ajwm transaction") + "\n" +
              "\n";
