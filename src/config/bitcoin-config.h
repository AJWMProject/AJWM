...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Ajwm Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Ajwm Core"
...
#define PACKAGE_BUGREPORT "https://github.com/ajwmproject/ajwm/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ajwm Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ajwm Core 0.16.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ajwm"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://ajwm.org/"
