...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // ajwm
        hashUTXORoot.SetNull(); // ajwm
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //ajwm
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //ajwm
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //ajwm
    {
