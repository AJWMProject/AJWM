#ifndef AJWMVERSIONCHECKER_H
#define AJWMVERSIONCHECKER_H

#include <QObject>

#define AJWM_RELEASES "https://github.com/ajwmproject/ajwm/releases"
...
class AjwmVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit AjwmVersionChecker(QObject *parent = 0);
    ~AjwmVersionChecker();
