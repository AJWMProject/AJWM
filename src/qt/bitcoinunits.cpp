...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("AJWM");
    case mBTC: return QString("mAJWM");
    case uBTC: return QString::fromUtf8("μAJWM");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Ajwms");
    case mBTC: return QString("Milli-Ajwms (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Ajwms (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
