...
Python code to generate the below hashes:
    ...
    reversed_hex(dsha256(''.join(struct.pack('<f', x) for x in range(0,1000)))) == '8e8b4cf3e4df8b332057e3e23af42ajwm663b61e0495d5e7e32d85099d7f3fe0c'
...
BOOST_AUTO_TEST_CASE(floats)
{
    ...
    BOOST_CHECK(Hash(ss.begin(), ss.end()) == uint256S("8e8b4cf3e4df8b332057e3e23af42ajwm663b61e0495d5e7e32d85099d7f3fe0c"));
